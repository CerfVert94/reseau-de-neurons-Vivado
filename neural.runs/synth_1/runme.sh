...
HD_PWD='/nfs/home/sasl/eleves/ei-se/3701019/Bureau/TP_CODESIGN/Neuron/neural/neural.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log neural_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source neural_wrapper.tcl

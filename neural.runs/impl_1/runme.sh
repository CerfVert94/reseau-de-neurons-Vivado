...
HD_PWD='/nfs/home/sasl/eleves/ei-se/3701019/Bureau/TP_CODESIGN/Neuron/neural/neural.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log neural_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source neural_wrapper.tcl -notrace
